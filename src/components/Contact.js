...
export const Contact = () =>{
    ...
    const handleSubmit = async (e) => {
        ...
        if(result.code === 200){
            ...
            setStatus({ success: false, message: 'Something went wrong... Message Failed to Sent'});
        }
    };
                    ...
                    <Col md={6}>
                        ...
                        <form onSubmit={handleSubmit}>
                            <Row>
                                ...
                                <Col sm={6} className="px-1">
                                    <input type="text" placeholder="Phone" value={formDetails.phone} onChange={ (e) => onFormUpdate( 'phone', e.target.value)} />
                                </Col>
                                <Col sm={12} className="px-1">
                                    <textarea row="6" placeholder="Message" value={formDetails.message} onChange={ (e) => onFormUpdate( 'message', e.target.value)} />
